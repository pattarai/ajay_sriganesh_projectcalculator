...
class Scific extends StatefulWidget {
  @override
...
class _Scific extends State<Scific> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      //appBar: AppBar(title: Text("Scientific Calculator",style: TextStyle(color: Colors.orange,fontSize: 25),),backgroundColor: Colors.black,),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: FlatButton(
                              ...
                              child: Text("00",style: TextStyle(fontSize: 22,color: Colors.white),),
                            ),
                          ),
                          Container(
                            height: 52,
